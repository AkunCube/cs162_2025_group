...
/*
 * List of sleep states for system processes.
 * This static structure maintains the queue of processes
 * currently in a sleep state.
 */
static struct list sleep_list;

static void decrement_sleep_ticks();
...
/**
 * @brief Decrement sleep ticks for blocked threads and wake up expired ones
 *
 */
static void decrement_sleep_ticks() {
